    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Rank', models.CharField(blank=True, choices=[('PVT', 'PVT'), ('PV2', 'PV2'), ('PFC', 'PFC'), ('SPC', 'SPC'), ('SGT', 'SGT'), ('SSG', 'SSG'), ('SFC', 'SFC'), ('MSG', 'MSG'), ('2LT', '2LT'), ('1LT', '1LT'), ('CPT', 'CPT'), ('MAJ', 'MAJ'), ('WO1', 'WO1'), ('CW2', 'CW2'), ('CW3', 'CW3')], max_length=155)),
                ('last_name', models.CharField(max_length=155)),
                ('first_name', models.CharField(max_length=155)),
                ('MOS', models.CharField(choices=[('14E', '14E'), ('14T', '14T'), ('14H', '14H'), ('14A', '14A'), ('140K', '140K'), ('25N', '25N'), ('25U', '25U')], max_length=155)),
                ('Postion', models.CharField(blank=True, choices=[('TD', 'Tactical Director'), ('TDA', 'Tactical Director Assistant'), ('TCO', 'Tactical Control Officer'), ('TCA', 'Tactical Control Assistant'), ('TPW', 'Early Warning Operator'), ('RO', 'Radio Operator/ Reports operator'), ('JWARN', 'JWARN Operator')], max_length=155)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Cso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stands.Cso')),
                ('icc_t1_complete', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stands.TdaTableOne')),
                ('icc_t2_complete', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stands.TdaTableTwo')),
                ('soldier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stands.Soldierdata')),
            ],
        ),
        migrations.CreateModel(
